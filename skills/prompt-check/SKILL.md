...
Agent({
  ...
  prompt: JSON.stringify({
    inputs: {
      ...
      report_language: "<from frontmatter.report_language>"
    },
    output_paths: {
...
TEMPLATE_STRINGS = {
  "tr": {
    ...
    "sentinel_todo_render": "TODO — yazar çözmeli",
    "sentinel_intentional_render": "Bilinçli — atla",
    "no_line_marker": "— / —"
  },
  "en": {
    ...
    "sentinel_todo_render": "TODO — author must resolve",
    "sentinel_intentional_render": "Intentional — dismiss",
    "no_line_marker": "— / —"
  }
}
```
